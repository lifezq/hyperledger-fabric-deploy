...
while getopts "h?a:u:" opt; do
  ...
  h | \?)
    echo "Usage: "
    echo "  generate-config.sh [options] <orderer_number> <kafka_number> <org_number>"
    echo "Options:"
    ...
    echo "Other:"
    echo "    - <orderer_number> default 3"
    echo "    - <kafka_number> default 3"
    echo "    - <org_number> default 3"
    exit 0
    ;;
  a)
    CA_SERVER=$OPTARG
